...
func (client *FileClient)parserRecvPkg(con *dxserver.DxNetConnection, resultpkg *ResultPkg)  {
...
func NewFileClient()*FileClient{
	...
	client.OnClientDisConnected = func(con *dxserver.DxNetConnection){
		if client.curOpFile!=nil{
			client.curOpFile.Close()
		}
		client.curResultPkg = nil
